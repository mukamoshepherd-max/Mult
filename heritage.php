...
<?php 
	$qrey=mysqli_query($connect,"select * from personal_details where my_id ='$tid'     ") or die(mysqli_error($connect));
...
<td>
<?php 
	$qry=mysqli_query($connect,"select * from personal_details where family_id ='$id' and my_id ='$_SESSION[ofatherid]'    ") or die(mysqli_error($connect));
...
<a href="prevg?id=<?php echo $rfw['id']; ?>" class="style3"> previous geneation</a></br>
...
if (strpos($prw[file], '.pdf'))
{
 ?>   
 <?php echo $prw['subject']; ?><a href="<?php echo $prw['file']; ?>" class="style3"><?php echo trim( $prw['file'],"/my heritage/files/"); ?> </a></br>
...
<img  align = "left"src="<?php echo $prw['file']; ?>" width="100" height="100" />
...
<video width="100%" height="240" controls  controlsList="nodownload">
  ...
  <source src="files/<?php echo trim( $rwp['file'],"/my heritage/files/"); ?>" type="video/mp4">
...
<button type="button" class="collapsible"> tagged</a></button>
<div class="content">
...
<?php 
		 $sql12 = "select * from history where history_id = ''   order by date  ";
$result12= $connect->query($sql12);
...
<td>
<?php 
	$qry=mysqli_query($connect,"select * from personal_details where  my_id ='6TA2'    ") or die(mysqli_error($connect));
	while($srw=mysqli_fetch_array($qry))
	{
	?>

spouse id:<?php echo $srw['my_id']; ?></br>
spouse name:<?php echo $srw['name']; ?>  <?php echo $rw['second_name']; ?>  <?php echo $rw['surname']; ?></br>
spouse gender:<?php echo $srw['gender']; ?></br>
spouse dob:<?php echo $srw['dob']; ?></br>
spouse dod:<?php echo $srw['dod']; ?></br>
<a href="motherprevg?id=<?php echo $srw['id']; ?>" class="style3"> previous geneation</a></br>
<div class="box">
...
<?php 
	$qry=mysqli_query($connect,"select *from history,personal_details where  history.history_id ='$pid' and history.spouse_id !=''   ") or die(mysqli_error($connect));
...
<a href="prevg?id=<?php echo $r['id']; ?>" class="style3"> previous geneation</a></br>
<div class="box">
...
<td bgcolor = "green">
<?php 
	$qry=mysqli_query($connect,"select * from personal_details where  father_id ='$_SESSION[ofatherid]'    ") or die(mysqli_error($connect));
...
?>
 ...
 </td> <td><a href="prevg?id=<?php echo $rew['id']; ?>" class="style3"> previous geneation</a></td> <td> </td> <td><a href="
<?php
$nextmale = "nextg";
$nextfemale= "snextg";
if($r1w[gender]== 'female')  
{
echo  $nextfemale;
}
else 
...
?>?id=<?php echo $r1w['id']; ?>" class="style3"> next geneation</a></td></br>
</tr>
