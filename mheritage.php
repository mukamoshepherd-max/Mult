...
<td>
<?php 
	$qry=mysqli_query($connect,"select * from personal_details where family_id ='$_SESSION[mfamilyid]' and my_id ='$_SESSION[mfatherid]'    ") or die(mysqli_error($connect));
...
<a href="mprevg?id=<?php echo $rfw['id']; ?>" class="style3"> previous geneation</a></br>
...
?>
 ...
 </td> <td><a href="mprevg?id=<?php echo $rew['id']; ?>" class="style3"> previous geneation</a></td> <td> </td> <td><a href="
