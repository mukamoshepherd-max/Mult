...
<td>
<?php 
	$qry=mysqli_query($connect,"select * from personal_details where  my_id ='$_SESSION[fatherid]'    ") or die(mysqli_error($connect));
...
<a href="smprevg?id=<?php echo $rfw['id']; ?>" class="style3"> previous geneation</a></br>
...
<a href="sfprevg?id=<?php echo $srw['id']; ?>" class="style3"> previous geneation</a></br>
<div class="box">
...
<td bgcolor = "green">
<?php 
	$qry=mysqli_query($connect,"select * from personal_details where  father_id ='$_SESSION[fatherid]'    ") or die(mysqli_error($connect));
...
<td>
<div class="box">
	<a class="button" href="#popup2<?php echo $r1w['my_id']; ?>"> view media</a>
</div>
...
?>
 ...
 </td> <td><a href="smprevg?id=<?php echo $rew['id']; ?>" class="style3"> previous geneation</a></td> <td> </td> <td><a href="
