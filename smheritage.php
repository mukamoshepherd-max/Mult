...
<td>
<?php 
	$qry=mysqli_query($connect,"select * from personal_details where family_id ='$id' and my_id ='$_SESSION[fatherid]'    ") or die(mysqli_error($connect));
...
?>
 ...
 </td> <td><a href="sprevg?id=<?php echo $rew['id']; ?>" class="style3"> previous geneation</a></td> <td> </td> <td><a href="
<?php
$nextmale = "smnextg";
$nextfemale= "snextg";
